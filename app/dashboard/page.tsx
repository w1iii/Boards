        ...
        <section className="max-w-[1440px] mx-auto px-margin-mobile md:px-margin-desktop py-12">
          ...
          <div className="flex items-end justify-between border-b border-tertiary pb-4 mb-8">
            <h2 className="font-headline-lg uppercase tracking-tight">
              Content Mastery Breakdown
            </h2>
            <Link
              className="font-label-caps text-primary flex items-center gap-2"
              href="/progress"
            >
              VIEW FULL ANALYTICS{" "}
          ...
          {/* Progress Grid (Bento Style) */}
          <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter mb-12">
            {areaOrder.map((areaKey) => {
              const score = areaScores.get(areaKey) ?? 0
              ...
              switch (areaKey) {
                case "pnle-iv":
                  return (
                    <div
                      key={areaKey}
                      className="md:col-span-8 bg-surface border border-tertiary p-10 flex flex-col justify-between"
                    >
                      <div>
                      ...
                      <div className="mt-12 flex gap-12">
                        <div>
                          <p className="font-label-caps text-secondary text-[10px]">STRENGTH</p>
                          <p className="font-mono-data">Cardiovascular</p>
                        </div>
                        <div>
                          <p className="font-label-caps text-secondary text-[10px]">CHALLENGE</p>
                          <p className="font-mono-data">Endocrine System</p>
                        </div>
                      </div>
                    </div>
                  )
                  ...
                  return (
                    <div key={areaKey} className="md:col-span-4">
                      <AreaCard
                        label={label}
                        score={score}
                        variant={score > 0 && score < 60 ? "alert" : "default"}
                      />
                    </div>
                  )
                default:
